...
import { ArrowLeft, Plus, Trash2, Save, AlertCircle, Video, Play, Youtube, Loader2 } from 'lucide-react';
  ...
  const fetchMediaData = async () => {
    try {
      ...
      setFormData({
        ...
        preVideoContent: data.preVideoContent || {
          learningObjectives: [''],
          prerequisites: [''],
          keyTerms: [{ term: '', definition: '' }]
        },
        postVideoContent: data.postVideoContent || {
          keyConcepts: [''],
          reflectionQuestions: [''],
          practicalApplications: [''],
          additionalResources: [{ title: '', url: '' }]
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Loading media data...</p>
          </div>
        </div>
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Edit Media</h1>
          <p className="text-gray-600">Update YouTube video or short content</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Configure where this media belongs and what type it should be</CardDescription>
          </CardHeader>
